...
<%
    ...
    blog.setBlogMd(set.getString("blogMd"));
%>
<html>
...
<button onclick="returnLast()" style="float: left">返回</button>
<form action="http://localhost:8080/Blog/updateBlogServlet?blogId=<%=blogId%>" id="htmlform" name=""htmlform method="post">
    ...
    标题:<input type="text" id="title" name="title" value="<%=blog.blogName%>">
    <button type="button" data-toggle="modal" data-target="#myModal">提交</button>
</form>
<div id="test-editormd">
    <div id="my-editormd">
        <textarea class="editormd-markdown-textarea" name="mdhtml" id="mdhtml" style="display:none;" form="htmlform"><%=blog.blogMd%></textarea>
